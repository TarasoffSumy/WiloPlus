...
.radio-item-phasa {
    ...
    padding: 5px;
                ...
                <!-- <h3>Підібраний насос</h3>                   
                    <el-row>
                    <el-col  :span="4" >                    
                    <el-button @click="onDeletePump" type="text" class="delete"><i style="font-size:22px" class="el-icon-circle-close-outline"></i></el-button> 
                    <img class="img-pump" width="65" :src="url+'assets/wilo-spu4.jpg'"/>   
                    </el-col>
                    <el-col  :offset="1"  :span="19" >                    
                       <h4 style="margin: 10px 0 15px 0;">ACTUN {{objSelectedPump.shortName}}</h4>
                        <p>Тип живлення:</p>                
                                <div v-for="item in objPump" :value="item" :key="item.id" class="radio-item-phasa" >
                                       <el-radio v-model="objPump.id" :label="item.id" @change="handleChangePhase(item.id)">
                                       <span v-if="item.features.phase=='1'"> 
                                                        <el-popover
                                                            placement="top-start"
                                                            width="250"
